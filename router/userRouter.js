...
router.post('/formularioRegistro',validationRecord, userController.storeUsers);

// router.post('/formularioRegistro',uploadFile.single('avatar'),validationLogin, userController.processRegistrer);
